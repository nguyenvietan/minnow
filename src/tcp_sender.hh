...
{
private:
  uint64_t ms_since_beginning_ {};
  uint64_t initial_RTO_ms_ {};
  uint64_t cur_RTO_ms_ {};

public:
  Timer( uint64_t initial_RTO_ms ) : initial_RTO_ms_( initial_RTO_ms ), cur_RTO_ms_ { initial_RTO_ms } {};
  void reset();
  void set_ms_since_begining( uint64_t x );
